...
<head>
	...
	<script type="text/javascript">
		function seleccionarPrecio(){
			...
			location.href = "movilesTablets.php?precio=" + precio;
		}
	</script>
</head>
<body>
			...
			<div class="row">
				...
				<div class="col-9">
					<?php
						...
						$consulta = mysqli_query($conexion, "SELECT * FROM producto WHERE CATEGORIA='Moviles y Tablets'") or die("Error en la consulta");
