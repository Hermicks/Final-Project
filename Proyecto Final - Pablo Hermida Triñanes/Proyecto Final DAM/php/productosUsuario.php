...
<body>
	...
	<section>
		<div class="container p-2">
			<div class="row">
				<p class="alert alert-dismissible bg-white w-100" id="botonVolver">
					<a href="index.php"><strong>Volver a Inicio</strong></a>
				</p>
			</div>
			<div class="row p-5">
					<?php 
						$idUsuario = $_GET['idUsuarioSubida'];
						...
						if(!empty($idUsuario)){
							...
							if($nFilas > 0){
								...
								echo "<script>alert('El usuario no ha subido ningún producto');</script>";
								mysqli_close($conexion);
							}
