...
<body>
	<?php
		...
		$idProducto = $_GET['idProductoComprado'];
		$descripcion = "";
		$direccion = "";
		$precio = "";
		$fecha = "";
		...
		$consulta = mysqli_query($conexion, "SELECT * FROM transacciones WHERE ID_CLIENTE='" . $idUsuario . "' AND ID_PRODUCTO='" . $idProducto . "'") or die("Error en la consulta");
		...
		<div class="container p-5">
			<div class="row bg-white">
				...
				<form action="" method="post">
						<label for="datosProducto" class="font-weight-bold">Has Comprado</label>
						...
						<label for="direccion" class="font-weight-bold">Se enviará a:</label>
						...
						<label for="metodoPago" class="font-weight-bold">Método Pago Elegido</label>
						<input type="text" name="metodoPago" class="form-control" required disabled
							<?php 
								if(!empty($metodoPago)){
									echo "value='" . $metodoPago . "'";
								}
							?>
						>
						<br/>
						...
						<input type="submit" name="seguirComprando" value="Seguir Comprando" class="btn btn-success w-100">
					</form>
				</div>
			</div>
		</div>
